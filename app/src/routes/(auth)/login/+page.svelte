...
>
	...
	<div class="lg:p-8">
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			...
			<UserAuthForm {supabase} />
			<span class="text-sm text-muted-foreground w-full text-center">Don't have an account? <a class="text-primary" href="/signup">Sign Up</a></span>
