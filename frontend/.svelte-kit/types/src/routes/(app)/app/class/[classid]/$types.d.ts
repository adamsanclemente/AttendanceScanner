...
type RouteId = '/(app)/app/class/[classid]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/app/class/[classid]/+page.server.js').load>>>>>>;
