...
type LayoutRouteId = RouteId | "/(app)/app/admin"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/app/admin/+page.server.js').load>>>>>>;
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/app/admin/+layout.server.js').load>>>>>>;
