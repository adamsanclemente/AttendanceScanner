...
type RouteId = '/(app)/app/student/[studentid]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/app/student/[studentid]/+page.server.js').load>>>>>>;
