...
type LayoutRouteId = RouteId | "/(app)/app" | "/(app)/profile"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../node_modules/@sveltejs/kit/src/routes/(app)/+layout.server.js').load>>>>>>;
